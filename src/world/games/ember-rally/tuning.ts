...
export const DIALS: readonly Dial[] = [
  ...
  },
  {
    ...
    group: 'helpers',
    name: 'Slide recovery',
    note: 'Damps excess rotation in accidental slides. Deliberate handbrake drifts use their own balance, so this keeps ordinary driving forgiving without pulling a drift straight.',
    low: 'raw car',
  ...
  // --- drift ---------------------------------------------------------------
  {
    ...
    group: 'drift',
    name: 'Drift angle',
    note: 'The base angle of a deliberate drift. Throttle and steering deepen or reduce it. More hangs the rear further out and costs more momentum.',
    low: 'a hint',
    high: 'right out',
    min: 0.1,
    max: 1,
