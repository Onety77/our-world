...
import { Board, Tray, Word } from './stones'
          ...
          <>
            ...
            */}
            <Tray
              ...
              onEnter={commit}
              onRub={rub}
              canEnter={typed.length === LENGTH && !sending}
              canRub={!sending && typed.length > 0}
              busy={sending}
              enterLabel={choosing ? say('give {her} this word') : 'lay this word down'}
            />
            {/*
